...
CREATE TABLE `SnowKMS`.`emails` ( `Id` BIGINT NOT NULL AUTO_INCREMENT , `ReceiveDate` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP , `RAW` LONGTEXT NOT NULL , `MessageId` VARCHAR(500) NOT NULL , `ReplyId` VARCHAR(500) NOT NULL , `Sender` VARCHAR(300) NOT NULL , `Date` VARCHAR(50) NOT NULL , `Message` LONGTEXT NOT NULL , `MessageNormal` LONGTEXT NOT NULL , PRIMARY KEY (`Id`)) ENGINE = InnoDB;